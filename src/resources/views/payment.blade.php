...
@section('main')
    ...
    <form class="payment-content" action="/purchase/payment/select/{{ $item_id }}" method="post">
        @csrf
            ...
            <div class="radio-list">
                <label class="payment-label">
                    ...
                    <span class="card-brand__area">
                        <img class="card-brand__area-img" src=" " alt="JCB">
                        <img class="card-brand__area-img" src=" " alt="MasterCard">
                        <img class="card-brand__area-img" src=" " alt="Visa">
                    </span>
                </label>
                            ...
                            <td class="card-image">
                                <label class="payment-label">
                                    <div class="radio-list">
                                        ...
                                        <img class="card-brand__image" src=" " alt="">
                                    </div>
                                </label>
                            </td>
                            <td class="card-brand">{{-- カードブランド --}}</td>
                            <td class="card-number">{{-- 下４桁 カード番号 --}}</td>
                            ...
                            <div class="create-card__group">
                                ...
                                <div class="create-card__box">
                                    <div class="create-card__area">
                                        ...
                                        <input class="input-name" type="text" size="41" placeholder="TARO YAMADA">
                                    </div>
                                    <input class="input-button" type="button" value="追加">
                                </div>
                            </div>
                        </div>
                    </div>
