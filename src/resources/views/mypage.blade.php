...
@section('main')
    <div class="user-content">
        ...
        <a class="user-content__profile" href="/mypage/profile">プロフィール編集</a>
    </div>

    <div class="tab-bontent">
        <label class="tab-content__label">
            <input class="tab-content__input" typa="radio" name="tab" value="sell_items" checked>出品した商品
        </label>
        ...
        @if(!$hasAnyRole)
            <label class="tab-content__lavel">
