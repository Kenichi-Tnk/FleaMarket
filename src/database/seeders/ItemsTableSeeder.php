...
class ItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Item::create([
            ...
            'img_url' => 'img/dummy/HDD+Hard+Disk.jpg',
            'user_id' => '2',
            'condition_id' => '2',
            'created_at' => now(),
            'updated_at' => now(),
        ...
        Item::create([
            ...
            'img_url' => 'img/dummy/iLoveIMG+d.jpg',
            'user_id' => '3',
            'condition_id' => '4',
            'created_at' => now(),
            'updated_at' => now(),
        ...
        Item::create([
            ...
            'price' => '4000',
            'description' =>"カラー:ブラック\n\nクラシックなデザインの革靴。",
            'img_url' => 'img/dummy/Leather+Shoes+Product+Photo.jpg',
            'user_id' => '4',
            'condition_id' => '5',
            'created_at' => now(),
            'updated_at' => now(),
        ...
        Item::create([
            ...
            'img_url' => 'img/dummy/Music+Mic+4632231.jpg',
            'user_id' => '2',
            'condition_id' => '5',
            'created_at' => now(),
            'updated_at' => now(),
